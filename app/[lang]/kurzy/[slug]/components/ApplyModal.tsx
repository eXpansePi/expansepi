...
function getTranslations(lang: string): ModalTranslations {
    const t: Record<string, ModalTranslations> = {
        cs: {
            title: "Máte zájem? Ozveme se vám.",
            ...
            defaultMessage: (title: string) =>
                `Dobrý den,\nrád bych se dozvěděl více o rekvalifikačním kurzu "${title}".`,
        },
        en: {
            title: "Interested? We'll get in touch.",
            name: "Full Name",
            ...
            defaultMessage: (title: string) =>
                `Hello, I would like to learn more about the course "${title}".`,
        },
        ru: {
            title: "Интересно? Мы свяжемся с вами.",
            name: "Имя и фамилия",
            ...
            defaultMessage: (title: string) =>
                `Здравствуйте, я хотел бы узнать больше о курсе "${title}".`,
        },
    }
    return t[lang] || t.cs
}
