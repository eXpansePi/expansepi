                ...
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                    <div className="flex flex-wrap items-baseline gap-3">
                      ...
                      <span className="text-2xl sm:text-3xl font-bold text-green-600">{t.courses.priceFrom}</span>
                    </div>
                    {courseData.funding && (
                  ...
                  <p className="text-sm sm:text-base text-gray-700">{t.courses.installments}</p>
                </div>
              ) : (
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center gap-4 sm:gap-6">
